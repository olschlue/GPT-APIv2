...
CREATE TABLE IF NOT EXISTS krisp_meetings (
    ...
    action_items TEXT NULL COMMENT 'Aufgaben/To-dos als JSON (Analyse-Modell)',
    key_points TEXT NULL COMMENT 'Entscheidungen, Risiken, offene Fragen als JSON (Analyse-Modell)',
    recording VARCHAR(255) NULL COMMENT 'Aufnahme-Dateiname oder -Pfad',
    recording_url VARCHAR(1000) NULL COMMENT 'URL zur Aufnahme',
    ...
    raw_payload MEDIUMTEXT NULL COMMENT 'Komplette Roh-Response der OpenAI API als JSON',
